    ...
    for path, folders, files in os.walk(path):
        ...
        for file in files:
            ...
            if write_changes:
                ...
                overwrite_file_without_metadata(os.path.join(path, file), os.path.join(path, target))
...
def overwrite_file_without_metadata(source_file, target_file):
    try:
        ...
        print(f'Obfuscate file error {source_file} => {target_file}: {e}')
